# Create garbled_circuit.h
garbled_circuit_h = """#pragma once
...
public:
    ...
    struct EvaluationStats {
        int gates_evaluated;
        int decryption_attempts;
        int successful_decryptions;
...
with open("garbled_circuits_utility/src/garbled_circuit.h", "w") as f:
    f.write(garbled_circuit_h)

print("garbled_circuit.h created successfully!")
print(f"Header length: {len(garbled_circuit_h)} characters")