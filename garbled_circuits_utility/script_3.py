# Create common.h with shared definitions
...
with open("garbled_circuits_utility/include/common.h", "w") as f:
    f.write(common_h)

print("common.h created successfully!")
print(f"File length: {len(common_h)} characters")