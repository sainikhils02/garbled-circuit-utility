# Create crypto_utils.h
crypto_utils_h = """#pragma once
...
with open("garbled_circuits_utility/src/crypto_utils.h", "w") as f:
    f.write(crypto_utils_h)

# Create crypto_utils.cpp
crypto_utils_cpp = """#include "crypto_utils.h"
#include <iomanip>
#include <sstream>
#include <cstring>
...
with open("garbled_circuits_utility/src/crypto_utils.cpp", "w") as f:
    f.write(crypto_utils_cpp)

print("crypto_utils.h and crypto_utils.cpp created successfully!")
print(f"Header length: {len(crypto_utils_h)} characters")
print(f"Implementation length: {len(crypto_utils_cpp)} characters")